                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                <td>교육생 이름</td>
                                <td colspan="3">
                                    <input type="text" name="mname" id="mname" v-model.trim="member.mname"
                                        placeholder="이름" style="width: 150px;" @input="namePatternCheck()">
                                ...
                                <td colspan="3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input type="text" class="form-control ms-2" name="emailBack" id="emailBack"
                                            @input="emailPatternCheck()" style="width: 150px;" />
